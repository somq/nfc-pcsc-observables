...
const ndef = require('../src/ndefFormat/ndefFormat2')
...
nfc.on('reader', async reader => {
	...
	reader.on('card', async card => {
		...
		// try {
			...
			// var rawDataMSBFirst = toggleEndianness(rawData, 32);


// var data = ndef.getBufferForText("abcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijklabcdefghijkl","fr");
// var data = ndef.getBufferForText("U2FsdGVkX19Buxk/sTWmdXFrfCgNsfmxJOqTvoJxW4kHS7+phRSqIegFb//zXmREjZLsaEK2RqIpBMyihlUuA48V6FQGvLyCPz948b5zv3Y=","fr");
var data = ndef.getBufferForText("123412341234","fr");
// var data = ndef.getBufferForText("1234","fr");
